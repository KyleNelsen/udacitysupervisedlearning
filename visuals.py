...
def evaluate(results, accuracy, f1):
    ...
    ax[0, 1].axhline(y=accuracy.iloc[0], xmin=-0.1, xmax=3.0, linewidth=1, color='k', linestyle='dashed')
    ax[1, 1].axhline(y = accuracy.iloc[0], xmin = -0.1, xmax = 3.0, linewidth = 1, color = 'k', linestyle = 'dashed')
    ax[0, 2].axhline(y = f1.iloc[0], xmin = -0.1, xmax = 3.0, linewidth = 1, color = 'k', linestyle = 'dashed')
    ax[1, 2].axhline(y = f1.iloc[0], xmin = -0.1, xmax = 3.0, linewidth = 1, color = 'k', linestyle = 'dashed')
